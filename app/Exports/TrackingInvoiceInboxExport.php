...
class TrackingInvoiceInboxExport implements FromView
{
    private $request;
    ...
    public function view(): View
    {
        ...
        $jenis_invoice = $this->request['jenis_invoice_exp'];
        $no_prk = $this->request['no_prk_exp'];
        $kendala = $this->request['kendala_exp'];
        $jenis_prk = $this->request['jenis_prk_exp'];
        ...
        $inv = Invoice::select('invoices.*','rt.label as tahapan','his.is_verifikasi','his.is_complete','pjk.pajak','cur.currency','cur.code',DB::raw('GROUP_CONCAT(DISTINCT(h.penerima) SEPARATOR ",") as disposisi'))
