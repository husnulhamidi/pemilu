...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body"   style="background:#222 url('{{ asset('media/logos/tjb2.jpeg') }}');no-repeat center center;background-size:cover; background-attachment:fixed; ">
		<!--begin::Main-->
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid ">
				...
				<!--begin::Content-->
				<div class="col-lg-4 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
					<!--begin::Wrapper-->
						...
						<div class="login-form">
							...
							<form class="form" id="kt_login_singin_form" method="POST" action="{{ route('login') }}">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-4 px-5 rounded-lg border-0" type="email" name="email" autocomplete="off" required :value="old('email')" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-4 px-5 rounded-lg border-0" type="password" name="password" autocomplete="current-password" required />
								</div>
								<!--end::Form group-->
								<!--begin::Action-->
